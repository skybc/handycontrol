...
public class TitleElement
{
    ...
    public static readonly DependencyProperty VerticalAlignmentProperty = DependencyProperty.RegisterAttached(
        "VerticalAlignment", typeof(VerticalAlignment), typeof(TitleElement), new FrameworkPropertyMetadata( (VerticalAlignment.Center), FrameworkPropertyMetadataOptions.Inherits));
