...
namespace HandyControl.Controls
{
    ...
    public class Window : System.Windows.Window
    {
        ...
        public static readonly DependencyProperty TitleHeightProperty = DependencyProperty.Register(
                       nameof(TitleHeight), typeof(double), typeof(Window), new PropertyMetadata(32.0));
        ...
        public static readonly DependencyProperty BorderCornerRadiusProperty = DependencyProperty.Register(
                       nameof(BorderCornerRadius), typeof(CornerRadius), typeof(Window), new PropertyMetadata(default(CornerRadius)));
        ...
        // MustShowNoClientArea
        public static readonly DependencyProperty MustShowNoClientAreaProperty = DependencyProperty.Register(
                                  nameof(MustShowNoClientArea), typeof(bool), typeof(Window), new PropertyMetadata(ValueBoxes.TrueBox));
        public bool MustShowNoClientArea
        {
            get => (bool)GetValue(MustShowNoClientAreaProperty);
            set => SetValue(MustShowNoClientAreaProperty, value);
        }
        ...
        private void SwitchShowNonClientArea(bool showNonClientArea)
        {
            ...
            if (showNonClientArea|| MustShowNoClientArea)
            {
                if (IsFullScreen&&!MustShowNoClientArea)
                {
